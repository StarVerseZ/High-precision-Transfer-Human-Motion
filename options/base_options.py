...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        # input image channel输入图片的通道数目=input image kernel输入图片的卷积核的数目
        ...
        self.parser.add_argument('--openpose_only', action='store_true', help='use openpose only')
        self.parser.add_argument('--densepose_only', action='store_true', help='use densepose only')        
